...
public class ChartColorTemplates: NSObject
{
    ...
    public class func increaseORcrease () -> [UIColor]
    {
        return [
            UIColor(red: 191/255/0, green: 31/255.0, blue: 45/255.0, alpha: 1.0),
            UIColor(red: 84/255.0, green: 185/255.0, blue: 28/255.0, alpha: 1.0),
        ]
    }
