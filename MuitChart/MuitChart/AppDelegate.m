...
//    ManyPicViewController *VC = [[ManyPicViewController alloc] init];
//    PietestViewController *VC = [[PietestViewController alloc] init];
    
//    DiscountingViewController *VC = [[DiscountingViewController alloc] init];
